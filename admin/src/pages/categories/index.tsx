...
function Categories() {
  ...
  async function fetchData(current = 1, pageSize = 20, params = {}) {
    ...
    try {
      ...
      console.log(res);
      if (res) {
        dispatch({ type: UPDATE_LIST, payload: { data: res.data ? res.data.list :  res.data.list} });
        dispatch({
          type: UPDATE_PAGINATION,
          payload: { pagination: { ...pagination, current, pageSize, total: res.data ? res.data.totalCount : res.list.totalCount } },
        });
